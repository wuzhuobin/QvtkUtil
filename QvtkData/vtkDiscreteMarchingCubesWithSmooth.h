...
class QVTKDATA_EXPORT vtkDiscreteMarchingCubesWithSmooth : public vtkDiscreteMarchingCubes
{
public:
...
protected:
	...
	friend void Threading(vtkDiscreteMarchingCubesWithSmooth* _self);
	int RequestData(vtkInformation* request, vtkInformationVector** inputVector,
		vtkInformationVector* outputVector) VTK_OVERRIDE;
	std::vector<vtkWindowedSincPolyDataFilter*> WindowedSincPolyDataFilters;
	std::vector<vtkDiscreteMarchingCubes*> DiscreteMarchingCubes;
