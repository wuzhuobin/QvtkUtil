...
const QString LabelHelper::DEFAULT_PRESET_FILE(":/PresetFile/presets.xml");
...
bool Q::vtk::LabelHelper::readColorFile(QString path)
{
...
bool LabelHelper::readPresetFile(QString path)
{
  return true;
}
