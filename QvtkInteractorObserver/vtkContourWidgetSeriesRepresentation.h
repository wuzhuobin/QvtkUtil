#ifndef __VTK_CONTOUR_WIDGET_SERIES_REPRESENTATION_H__
#define __VTK_CONTOUR_WIDGET_SERIES_REPRESENTATION_H__
// me 
...
class QVTKINTERACTOROBSERVER_EXPORT vtkContourWidgetSeriesRepresentation: public vtkWidgetRepresentation
{
public:
	// Description:
	// Instantiate class.
	static vtkContourWidgetSeriesRepresentation *New();

	// Description:
	// Standard VTK methods.
	vtkTypeMacro(vtkContourWidgetSeriesRepresentation, vtkWidgetRepresentation);
...
protected:
	vtkContourWidgetSeriesRepresentation();
	virtual ~vtkContourWidgetSeriesRepresentation();
...
private:
	vtkContourWidgetSeriesRepresentation(const vtkContourWidgetSeriesRepresentation&);  //Not implemented
	void operator=(const vtkContourWidgetSeriesRepresentation&);  //Not implemented
};



#endif // !__VTK_CONTOUR_WIDGET_SERIES_REPRESENTATION_H__
