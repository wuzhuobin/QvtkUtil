#ifndef __VTK_CONTOUR_WIDGET_SERIES_H__
#define __VTK_CONTOUR_WIDGET_SERIES_H__
// me 
...
class QVTKINTERACTOROBSERVER_EXPORT vtkContourWidgetSeries : public vtkAbstractWidget
{
public:
	// Description:
	// Instantiate this class.
	static vtkContourWidgetSeries *New();

	// Description:
	// Standard methods for a VTK class.
	vtkTypeMacro(vtkContourWidgetSeries, vtkAbstractWidget);
	...
	void SetRepresentation(vtkContourWidgetSeriesRepresentation *rep)
	{
	...
	vtkContourWidgetSeriesRepresentation *GetvtkContourWidgetSeriesRepresentation()
	{
		return reinterpret_cast<vtkContourWidgetSeriesRepresentation*>(this->WidgetRep);
	}
...
private:
	vtkContourWidgetSeries(const vtkContourWidgetSeries&);  //Not implemented
	void operator=(const vtkContourWidgetSeries&);  //Not implemented
...
#endif // !__VTK_CONTOUR_WIDGET_SERIES_H__
